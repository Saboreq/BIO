...
export function BackToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-40 inline-flex h-11 w-11 items-center justify-center rounded-lg border border-sab-border bg-sab-bg-elev/95 text-sab-text backdrop-blur transition-all duration-300 hover:border-sab-border-purple ${show ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-3 opacity-0"}`}
    >
